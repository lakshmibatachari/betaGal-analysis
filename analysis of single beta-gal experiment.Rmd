...
```{r}
fileName <- "myData/LEB 7-30-18 Strain 34 35 36.xlsx" #Enter your Excel file here. Remember that tab completion will help you get the path & name correct
...
#includes a step to filter out blanks and "dropped" cells
...
ggplot(combinedData) + geom_point(aes(x=RpoS, y=`Miller Units`)) +
  facet_wrap(~strain, ncol=3, scales = "free") +
