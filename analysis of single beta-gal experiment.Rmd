...
```{r}
fileName <- "myData/7.18.18 core.xlsx" #Enter your Excel file here. Remember that tab completion will help you get the path & name correct
...
```{r}
setwd("/Users/Lakshmi/Desktop/R/betaGal-analysis/myFigures")
getwd()
jpeg("7.18.18 grid.jpg")
...
strainName <- "LZ40"
singlestrainMiller <- combinedData$`Miller Units`[combinedData$strain == strainName]
singlestrainRpoS <- combinedData$RpoS[combinedData$strain == strainName]


plot(singlestrainMiller ~ singlestrainRpoS, xlab = "% wildtype RpoS", ylab = "Miller Units", main = strainName)
