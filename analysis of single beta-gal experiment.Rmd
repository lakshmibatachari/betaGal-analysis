...
```{r}
fileName <- "myData/7.20.18 FRLZ Strain 39 40.xlsx" #Enter your Excel file here. Remember that tab completion will help you get the path & name correct
...
Plot one biological replicate of an individual strain

```{r}


strainName <- "FR39" #enter the strain name you wish to plot
singleStrain <- subset(combinedData, strain = strainName) 


ggplot(singleStrain) + 
  geom_point(aes(x = RpoS, y = `Miller Units`)) + 
